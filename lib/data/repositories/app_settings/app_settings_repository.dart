...
import 'package:my_weather/utils/extensions/string_extensions.dart';
...
@riverpod
void setDarkMode(SetDarkModeRef ref, bool isDarkMode) {
  final appSettingsRepository = ref.watch(appSettingsRepositoryProvider);
  return appSettingsRepository.setDarkMode(isDarkMode);
}
...
@riverpod
void setAppTemperature(SetAppTemperatureRef ref, AppTemperature temperature) {
  final appSettingsRepository = ref.watch(appSettingsRepositoryProvider);
  return appSettingsRepository.setAppTemperature(temperature);
}
